...
void RemoteDisplay::init(uint16_t inScreenWidth, uint16_t inScreenHeight, uint16_t inPortStream)
{
...
void RemoteDisplay::registerRefreshCallback(refresh_callback_t inRefreshCallback)
{
...
void  RemoteDisplay::registerTouchCallback(touch_callback_t inTouchCallback)
{
...
void  RemoteDisplay::registerCommandCallback(command_callback_t inCommandCallback)
{
...
#if defined(USE_ETHERNET)
void RemoteDisplay::connectRemoteEthernet(IPAddress ipRemote)
{
...
void RemoteDisplay::connectRemoteSerial()
{
...
void RemoteDisplay::connectRemote()
{
...
void RemoteDisplay::disconnectRemote()
{
...
void RemoteDisplay::sendData(const uint16_t x1, const uint16_t y1, const uint16_t x2, const uint16_t y2, uint8_t * pixelmap)
{
...
void RemoteDisplay::pollRemoteCommand()
{
...
void RemoteDisplay::processIncomingCommand(const char * incomingPacketBuffer)
{
...
void RemoteDisplay::sendHeader(uint16_t controlValue, uint32_t extraData)
{
...
void RemoteDisplay::sendPacket(uint8_t * buffer, uint32_t packetSize)
{
#if defined(USE_ETHERNET)
